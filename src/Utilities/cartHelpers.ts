...
//Funktion för att addera ihop den totala summan i sin kundkorg. Funktionen tar emot en array av produkter(IProduct[])
export const calculateTotalPrice = (cartItems: IProduct[]): number => {
